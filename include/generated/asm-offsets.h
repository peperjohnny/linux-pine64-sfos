...
#define TSK_ACTIVE_MM 872 /* offsetof(struct task_struct, active_mm) */
...
#define TSK_STACK_CANARY 1048 /* offsetof(struct task_struct, stack_canary) */

#define THREAD_CPU_CONTEXT 2400 /* offsetof(struct task_struct, thread.cpu_context) */
#define THREAD_KEYS_USER 3368 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 3448 /* offsetof(struct task_struct, thread.keys_kernel) */
